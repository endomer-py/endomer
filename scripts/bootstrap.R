...
paths<-c("artifacts/endom-closure-release/engihr/package/source-installed",
 "artifacts/endom-closure-release/enhogar/package/zip-installed",
 "artifacts/engihr-release/package/zip-installed",
 "artifacts/endomer-release/package/zip-installed",
